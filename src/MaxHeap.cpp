...
template <class T, class S>
MaxHeap<T,S>::MaxHeap(T value,S compareValue)
{
    // parametrised constructor

    // instantiating root Node of MaxHeap
...
template <class T,class S>
int MaxHeap<T,S>::pushBack(T value, S compareValue)
{
    if(this->mRoot == NULL)
    {
        this->mRoot= new typename Heap<T,S>::Node(++this->mTotalIndex,value,compareValue);
...
template <class T, class S>
int MaxHeap<T,S>::rearrangeHeap(typename Heap<T,S>::Node * node)
{
